...
These User Stories have been implemented on the Comic Books tabs of the Navbar. When clicking on this tab, it will redirect to a page that will list all the existent Comic Book records. If the user has the necessary access to edit/create new Comic Book records, then the buttons with each respective functionality will appear
